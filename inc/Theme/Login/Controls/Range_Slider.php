...
class Range_Slider extends \WP_Customize_Control
{
    ...
    {
        wp_enqueue_script('o2-range-slider', CT4GG_URL . 'assets/js/Login/Controls/range-slider-control.js', array( 'jquery' ), '', true);
        wp_enqueue_style('o2-range-slider', CT4GG_URL . 'assets/css/Login/Controls/range-slider-control.css');
    }
            ...
            <?php if (! empty($this->label)) : ?>
                ...
                <?php if (isset($this->choices['percent']) && ( $this->choices['percent'] !== false )) : ?>
                    <div class="button-group" data-setting="align">
                        ...
                        <label class="button" for="px-<?php echo esc_attr($this->id); ?>"><?php _e('px', 'ct4gg'); ?></label>
                        ...
                        <label class="button" for="percent-<?php echo esc_attr($this->id); ?>"><?php _e('%', 'ct4gg'); ?></label>
                    </div>
                <?php endif; ?>
                </span>
                <?php
            ...
            <div id="<?php echo esc_attr($this->id); ?>">
                <div class="o2-range-slider">
                    ...
                    <?php if (! empty($this->setting->default)) : ?>
                        <span class="o2-range-reset-slider" title="<?php _e('Reset', 'ct4gg'); ?>"><span class="dashicons dashicons-image-rotate"></span></span>
                    <?php endif; ?>
                </div>
            </div>
        </div>
