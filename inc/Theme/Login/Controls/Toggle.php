...
class Toggle extends \WP_Customize_Control
{
    ...
    {
        wp_enqueue_script('o2-toggle', CT4GG_URL . 'assets/js/Login/Controls/toggle-control.js', '', '', true);
        wp_enqueue_style('o2-toggle', CT4GG_URL . 'assets/css/Login/Controls/toggle-control.css');
    }
