...
?>
	<ul class="nav ct4gg-nav-tabs">
		...
		<li class="<?php echo esc_html( ( isset( $_POST['tab'] ) && sanitize_text_field( wp_unslash( $_POST['tab'] ) ) === 'tab-2' ) ? 'active' : '' ); ?>"><a href="#tab-2"><?php esc_html_e( 'Restore security.txt', 'ct4gg' ); ?></a></li>
	</ul>
