...
(function () {
		...
		function (e) {
			...
			custom_uploader.on(
				...
				function () {
					...
					jQuery( "input[name='" + selin + "']" ).each(
						function () {
							this.value = attachment.url
						}
					);
					jQuery( "img[name='" + selin + "']" ).each(
						function () {
	...
	on(
		'input',
		'#login_slugs_login, #login_slugs_logout, #login_slugs_register, #login_slugs_lostpassword, #login_slugs_resetpass, #login_slugs_postpass',
		function (e) {
