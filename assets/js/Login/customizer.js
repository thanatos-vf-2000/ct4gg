...
jQuery( document ).ready( function( $ ) {
	...
	*/
	wp.customize.panel( 'ct4gg_panel', function( section ) {
	...
	*/
	...
	wp.customize( 'ct4gg_options[ct4gg_logo_show]', function( setting ) {
	...
	*/
	...
	wp.customize( 'ct4gg_options[ct4gg_bg_image]', function( setting ) {
		setting.bind( function( value ) {
			if ( value === '' ) {
				$( '#customize-control-ct4gg_options-ct4gg_bg_image_size' ).hide();
				$( '#customize-control-ct4gg_options-ct4gg_bg_size' ).hide();
	...
	wp.customize( 'ct4gg_options[ct4gg_bg_image_size]', function( setting ) {
		setting.bind( function( value ) {
			if ( value === 'custom' ) {
				$( '#customize-control-ct4gg_options-ct4gg_bg_size' ).show();
			} else {
