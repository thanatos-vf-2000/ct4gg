...
jQuery(document).ready(function($) {
	...
	$('.ct4gg-color-control').each(function() {
		var $control = $(this),
		...
		$('<div class="ct4gg-alpha-container"><div class="slider-alpha"></div><div class="transparency"></div></div>').appendTo($control.parents('.wp-picker-container'));
